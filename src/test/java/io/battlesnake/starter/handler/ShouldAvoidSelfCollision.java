...
public class ShouldAvoidSelfCollision extends SnakeAppHandlerTest{
    ...
    void shouldAvoidSelfCollision10() throws Exception {
        String reqJson = JsonFixtures.read("fixtures/shouldAvoidSelfCollision10.json");
    ...
    @Test
    void shouldAvoidSelfCollision11() throws Exception {
        String reqJson = JsonFixtures.read("fixtures/shouldAvoidSelfCollision11.json");
