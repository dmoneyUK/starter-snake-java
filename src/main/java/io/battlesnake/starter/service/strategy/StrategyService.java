...
import static io.battlesnake.starter.service.strategy.StrategyTransitStage.Stage.TRAPPED;
...
public class StrategyService {
    ...
    private StageTransitRule[] strategySelectTable = {
            ...
            new StageTransitRule(NO_FOOD, chaseTailStrategy, DECIDED, TRAPPED),
            new StageTransitRule(TRAPPED, goFurthestStrategy, DECIDED, DECIDED),// TODO use hamilton instead of furthest
